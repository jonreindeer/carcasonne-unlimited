...
class CarcassonneGame {
    constructor() {
        ...
        this.SPRITE_TILE_WIDTH = 93; // Width of each tile in the sprite sheet (465/5)
        this.SPRITE_TILE_HEIGHT = 90; // Height of each tile in the sprite sheet (450/5)
    ...
    drawTile(tile) {
        ...
        // Draw the sprite
        this.ctx.drawImage(this.spriteSheet, tile.definition.spriteX * this.SPRITE_TILE_WIDTH, tile.definition.spriteY * this.SPRITE_TILE_HEIGHT, this.SPRITE_TILE_WIDTH, this.SPRITE_TILE_HEIGHT, -this.TILE_SIZE / 2, -this.TILE_SIZE / 2, this.TILE_SIZE, this.TILE_SIZE);
        this.ctx.restore();
    }
    updateTileCount() {
